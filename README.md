...
|-----------------------------------------------|-------|---------------------------------------------|
| 01. Convert hex to base64                     | Set 1 |[set1/challenge_01.py](set1/challenge_01.py) |
| 02. Fixed XOR                                 | Set 1 |[set1/challenge_02.py](set1/challenge_02.py) |
| 03. Single-byte XOR cipher                    | Set 1 |[set1/challenge_03.py](set1/challenge_03.py) |
| 04. Detect single-character XOR               | Set 1 |[set1/challenge_04.py](set1/challenge_04.py) |
| 05. Implement repeating-key XOR               | Set 1 |[set1/challenge_05.py](set1/challenge_05.py) |
| 06. Break repeating-key XOR                   | Set 1 |[set1/challenge_06.py](set1/challenge_06.py) |
| 07. AES in ECB mode                           | Set 1 |[set1/challenge_07.py](set1/challenge_07.py) |
| 08. Detect AES in ECB mode                    | Set 1 |[set1/challenge_08.py](set1/challenge_08.py) |
| 09. Implement PKCS#7 padding                  | Set 2 |[set2/challenge_09.py](set2/challenge_09.py) |
| 10. Implement CBC mode                        | Set 2 |[set2/challenge_10.py](set2/challenge_10.py) |
| 11. An ECB/CBC detection oracle               | Set 2 |[set2/challenge_11.py](set2/challenge_11.py) |
| 12. Byte-at-a-time ECB decryption (Simple)    | Set 2 |[set2/challenge_12.py](set2/challenge_12.py) |
| 13. ECB cut-and-paste                         | Set 2 |[set2/challenge_13.py](set2/challenge_13.py) |
| 14. Byte-at-a-time ECB decryption (Harder)    | Set 2 |[set2/challenge_14.py](set2/challenge_14.py) |
| 15. PKCS#7 padding validation                 | Set 2 |[set2/challenge_15.py](set2/challenge_15.py) |
| 16. CBC bitflipping attacks                   | Set 2 |[set2/challenge_16.py](set2/challenge_16.py) |
| 17. The CBC Padding oracle                    | Set 3 |[set3/challenge_17.py](set3/challenge_17.py) |
