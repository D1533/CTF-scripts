...
| Challenge | Category | Script | Concepts |
|-----------|----------|--------|----------|
| Abnormal Ellipse | crypto | [abnormal_ellipse.py](TAMUctf-2026/abnormal-ellipse/abnormal_ellipse.py) | |
| Hidden Log Factoring | crypto | [hidden_log_factoring.py](TAMUctf-2026/hidden_log_factoring/hidden_log_factoring.py) | |
