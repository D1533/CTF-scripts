...
| What does the f say?  | pwn      | [what_does_the_f_say.py](htb/pwn/what_does_the_f_say.py)               | Format string, ROP, PIE leak, libc leak, canary leak, libc version identification|
